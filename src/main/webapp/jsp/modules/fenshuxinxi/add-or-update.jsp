		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑分数信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>分数信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑分数信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">分数信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>年级班级</label>
										<input id="nianjibanji" name="nianjibanji" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>成绩分数</label>
										<input name="chengjifenshu" id="chengjifenshu" name="chengjifenshu" class="form-control" placeholder="成绩分数">
									</div>
	...
	<script>
		...
		function xuehaoSelect2Change(){
			...
			http("follow/xuesheng/xuehao","GET",{
				...
				if(res.code == 0){
					...
					if(res.data != null && res.data.nianjibanji != null){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "fenshuxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("fenshuxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("fenshuxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("fenshuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.nianjibanji != null && res.data.nianjibanji != ''){
							$('#nianjibanji').val(res.data.nianjibanji)
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chengjifenshu != null && res.data.chengjifenshu != ''){

						$("#chengjifenshu").val(res.data.chengjifenshu);
						$("#chengjifenshu").attr('readonly','readonly');
					}
