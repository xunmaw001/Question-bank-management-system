						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="nianjibanji" name="nianjibanji" class="form-control" v-model="ruleForm.nianjibanji" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>成绩分数</label>

									<input id="chengjifenshu" name="chengjifenshu" class="form-control" v-model="ruleForm.chengjifenshu" readonly>
									</div>
