...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教师电话</label>
										<input name="jiaoshidianhua" id="jiaoshidianhua" name="jiaoshidianhua" class="form-control" placeholder="教师电话">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
									...
									<div class="form-group col-md-6">
										<label>年级班级</label>
										<select id="nianjibanjiSelect" name="nianjibanji" class="form-control">
										</select>	
									</div>	
	...
	<script>
		...
		var nianjibanjiOptions = [];

		function nianjibanjiSelect(){
			http("option/nianjibanji/nianjibanji","GET",{},(res)=>{
				if(res.code == 0){
					nianjibanjiOptions = res.data;
					var nullOption = document.createElement('option');
					var nianjibanjiSelect = document.getElementById('nianjibanjiSelect');
					nianjibanjiSelect.appendChild(nullOption);
					for(var i=0;i<nianjibanjiOptions.length;i++){
						var nianjibanjiOption = document.createElement('option');
						nianjibanjiOption.setAttribute('name','nianjibanjiOption');
						nianjibanjiOption.setAttribute('value',nianjibanjiOptions[i]);
						nianjibanjiOption.innerHTML = nianjibanjiOptions[i];									
						if(ruleForm.nianjibanji == nianjibanjiOptions[i]){
							nianjibanjiOption.setAttribute('selected','selected');
						}
						nianjibanjiSelect.appendChild(nianjibanjiOption);
					}
				}
			});
		}	
		...
		function dataBind(){
			...
			$("#jiaoshidianhua").val(ruleForm.jiaoshidianhua);	
			$("#touxiang-input").val(ruleForm.touxiang);
			var nianjibanjiOptions = document.getElementsByClassName("nianjibanjiOption");
			for(var nianjibanjiCount = 0; nianjibanjiCount < nianjibanjiOptions.length;nianjibanjiCount++){
				if(nianjibanjiOptions[nianjibanjiCount].getAttribute('value') == ruleForm.nianjibanji){
					nianjibanjiOptions[nianjibanjiCount].setAttribute('selected','selected');
				}
			}
		}		
		//图片显示
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaoshidianhua != null && res.data.jiaoshidianhua != ''){

						$("#jiaoshidianhua").val(res.data.jiaoshidianhua);
						$("#jiaoshidianhua").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.nianjibanji != null && res.data.nianjibanji != ''){
						...
						var nianjibanjiOptions = document.getElementsByClassName("nianjibanjiOption");
						for(var nianjibanjiCount = 0; nianjibanjiCount < nianjibanjiOptions.length;nianjibanjiCount++){
							if(nianjibanjiOptions[nianjibanjiCount].getAttribute('value') == res.data.nianjibanji){
								nianjibanjiOptions[nianjibanjiCount].setAttribute('selected','selected');
							}
						}
					}
