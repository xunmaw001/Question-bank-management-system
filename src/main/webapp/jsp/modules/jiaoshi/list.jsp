...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jiaoshidianhua')">教师电话<i id="jiaoshidianhuaIcon" class="fa fa-sort"></i></th>
											<th>头像</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jiaoshidianhuaCell  = document.createElement('td');

						 jiaoshidianhuaCell.innerHTML = item.jiaoshidianhua;

			row.appendChild(jiaoshidianhuaCell);
